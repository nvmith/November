...
|22주차|GameTheory|[BOJ32871](./cur_study/GameTheory/BOJ32871)|[BOJ9660](./cur_study/GameTheory/BOJ9660)||
...
## ⚙️ 배치파일 작동 방식
- `november.bat` 실행 시 메뉴가 출력됩니다.

  1) 문제 추가  
  → 선택한 알고리즘 폴더 내부에 새로운 **문제 폴더**를 생성합니다.  

  2) 지각/결석 로그 추가  
  → `README.md`의 **지원금 내역** 섹션에 지각/결석 기록을 한 줄 자동으로 추가합니다.  

  3) 주차 업데이트  
  → `README.md`의 **History 테이블**에 새로운 주차 줄을 생성합니다.  
   - **Normal 주차**: 하나의 알고리즘을 정해 2~3문제를 등록 (분류는 해당 알고리즘명으로 표시)  
   - **Review 주차**: 지난 3주간의 알고리즘을 복습, 각 알고리즘에서 한 문제씩 총 3문제를 등록  
     → 분류는 **복습주간**으로 표시되며, 문제 앞에 알고리즘명이 함께 적힙니다.  
...
## 그룹장
- 매달 한 번씩 당선, 연임 가능
- 문제 폴더 생성, README, 후기, 일정 관리 등 잡다한 일 담당
